...
# print(urllib.parse.quote_plus(access_key + '/' + credential_scope))
canonical_querystring = 'X-Amz-Algorithm=AWS4-HMAC-SHA256'
canonical_querystring += '&X-Amz-Credential=' + (access_key + '/' + credential_scope).replace("/", "%2F")
...
webbrowser.open("https://" + host + canonical_uri + "?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=" + access_key + "/" + datestamp + "/" + region + "/s3/aws4_request" + '&X-Amz-Date=' + amz_date + '&X-Amz-Expires=86400' + '&X-Amz-SignedHeaders=' + signed_headers + '&X-Amz-Signature=' + signature)
